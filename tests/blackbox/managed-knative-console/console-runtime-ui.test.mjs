/**
 * bbx-933-console-01..09 | fn-knative-runtime-status, fn-mcp-hosted-runtime, fn-function-action-mutation, fn-function-runtime-availability-gate
...
test('bbx-933-console-01..09: managed Knative console public behavior', () => {
