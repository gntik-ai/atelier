/**
 * bbx-933-console-01..06 | fn-knative-runtime-status, fn-mcp-hosted-runtime, fn-function-action-mutation
...
test('bbx-933-console-01..06: managed Knative console public behavior', () => {
